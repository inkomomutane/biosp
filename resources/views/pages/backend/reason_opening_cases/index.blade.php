...
@section('dashboard_title', __('Reason of opening cases'))
@section('title', __('Reason of opening cases'))
@section('content')
                ...
                <div class="card mb-5 mb-xl-7">
                    ...
                    <div class="card-header border-0 pt-3">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 mb-1">{{ __('Reason of opening cases') }}</span>
                            <span class="text-muted mt-1 fw-semibold fs-7"></span>
                        </h3>
                        <div class="card-toolbar">
                            <a href="{{ route('reason_opening_case.create') }}" class="btn btn-sm btn-light-info">
                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                                <span class="svg-icon svg-icon-2">
                                   @svg('fluentui-people-community-20-o')
                                </span>
                                <!--end::Svg Icon-->{{  __(key:'Create :resource',replace:[ 'resource' => Str::lower(__('Reason of opening case'))]) }}
                            </a>
                        </div>
                    </div>
                    <!--end::Header-->
                            ...
                            <table class="table table-row-bordered responsive nowrap" style="width: 100%">
                                ...
                                <thead>
                                    <tr class="fw-bolder fs-7 text-light bg-dark rounded">
                                        <th class="ps-4 rounded-start">{{ __('Reason of opening case') }}</th>
                                        <th class="">{{ __('Name') }}</th>
                                ...
                                <!--begin::Table body-->
                                <tbody>
                                    @forelse ($reason_opening_cases as $reason_opening_case)
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-5">
                                                        <div
                                                            ...
                                                            {{ explode(' ', $reason_opening_case->name)[0][0] }}
                                                            {{ explode(' ', $reason_opening_case->name)[1][0] ?? '' }}
                                                        </div>
                                                    </div>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <a href="#"
                                                    ...
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title=" {{__(key:'Delete :resource',replace:[ 'resource' => Str::lower(__('Reason of opening case'))]) }} ">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5">{{ __(key:'No :resource found.',replace:[ 'resource' => Str::lower(__('Reason of opening cases'))]) }}</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                                <!--end::Table body-->
