...
{{--        <x-biosp-service-card name="Serviços do Biosp"  :services="\App\Models\Biosp::all()" >--}}
{{--            <x-slot:buttons>--}}
...
{{--        Launch demo modal--}}
{{--    </button>--}}
{{--    <x-modal trigger="kt_modal_1" >--}}
{{--        <x-slot name="buttons">--}}
{{--            <x-modal-button title="Close" class-name="btn-secondary" :dismiss="true"/>--}}
{{--            <x-modal-button class-name="btn-success" type="submit" >--}}
{{--                <x-slot name="title">--}}
{{--                    <span class="svg-icon svg-icon-1">--}}
{{--                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">--}}
