...
@section('dashboard_title', __('Document types'))
                ...
                <div class="card mb-5 mb-xl-7">
                    ...
                    <div class="card-header border-0 pt-3">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 mb-1">{{ __('Document types') }}</span>
                            <span class="text-muted mt-1 fw-semibold fs-7"></span>
                        </h3>
                        <div class="card-toolbar">
                            <a href="{{ route('document_type.create') }}" class="btn btn-sm btn-light-info">
                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                                <span class="svg-icon svg-icon-2">
                                    @svg('fluentui-flag-48')
                                </span>
                                <!--end::Svg Icon-->{{  __(key:'Create :resource',replace:[ 'resource' => Str::lower(__('Document type'))]) }}
                            </a>
                        </div>
                    </div>
                    <!--end::Header-->
                            ...
                            <table class="table table-row-bordered responsive nowrap" style="width: 100%">
                                ...
                                <thead>
                                    <tr class="fw-bolder fs-7 text-light bg-dark rounded">
                                        <th class="ps-4 rounded-start">{{ __('Document type') }}</th>
                                        <th class="">{{ __('Name') }}</th>
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-5">
                                                        <div
                                                            ...
                                                            {{ explode(' ', $document_type->name)[0][0] }}
                                                            {{ explode(' ', $document_type->name)[1][0] ?? '' }}
                                                        </div>
                                                    </div>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <a href="#"
                                                    ...
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title=" {{__(key:'Delete :resource',replace:[ 'resource' => Str::lower(__('Document type'))]) }} ">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5">{{ __(key:'No :resource found.',replace:[ 'resource' => Str::lower(__('Document types'))]) }}</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                                <!--end::Table body-->
