    ...
    <div class="row justify-content-center pt-2">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <!--begin::Notice-->
                <div class="notice d-flex bg-light-warning rounded border-warning mb-4 border border-dashed min-w-lg-600px flex-shrink-0 p-6">
                    <!--begin::Icon-->
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8 fv-row">
                                <div class="input-group flex-nowrap">
                                    <select @if (auth()->user()->uuid == $user->uuid) disabled @endif name="role"
                                        class="form-select form-select-solid" data-control="select2"
                                        data-placeholder="{{ __('Change user role') }}">


                                        @foreach ($roles as $role)
                                            <option value="{{ $role->id }}"
                                                @if ($user->hasRole($role->name)) selected @endif><span
                                                    class="text-capitalize text-mutted"> {{ $role->name }}</span>
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
