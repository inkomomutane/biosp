...
@section('dashboard_title', __('Provinces'))
                ...
                <div class="card mb-5 mb-xl-7">
                    ...
                    <div class="card-header border-0 pt-3">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 mb-1">{{__('Provinces')}}</span>
                            <span class="text-muted mt-1 fw-semibold fs-7"></span>
                        </h3>
                        <div class="card-toolbar">
                            <a href="{{ route('province.create') }}" class="btn btn-sm btn-light-info">
                            ...
                            <table  class="table table-row-bordered responsive nowrap" style="width: 100%">
                                ...
                                <thead>
                                    <tr class="fw-bolder fs-7 text-light bg-dark rounded">
                                        <th class="ps-4 rounded-start">{{__('Province')}}</th>
                                        <th class="">{{__('Country')}}</th>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-50px me-5">
                                                    ...
                                                    {{ explode(' ', $province->name )[0][0] }}
                                                    {{ explode(' ', $province->name )[1][0] ?? '' }}
                                                    </div>
                                                </div>
