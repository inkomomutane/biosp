...
@section('dashboard_title', __('Forwarded services'))
@section('title', __('Forwarded services'))
@section('content')
                ...
                <div class="card mb-5 mb-xl-7">
                    ...
                    <div class="card-header border-0 pt-3">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 mb-1">{{ __('Forwarded services') }}</span>
                            <span class="text-muted mt-1 fw-semibold fs-7"></span>
                        </h3>
                        <div class="card-toolbar">
                            <a href="{{ route('forwarded_service.create') }}" class="btn btn-sm btn-light-info">
                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                                <span class="svg-icon svg-icon-2">
                                    @svg('fluentui-square-arrow-forward-16')
                                </span>
                                <!--end::Svg Icon-->{{  __(key:'Create :resource',replace:[ 'resource' => Str::lower(__('Forwarded service'))]) }}
                            </a>
                        </div>
                    </div>
                    <!--end::Header-->
                            ...
                            <table class="table table-row-bordered responsive nowrap" style="width: 100%">
                                ...
                                <thead>
                                    <tr class="fw-bolder fs-7 text-light bg-dark rounded">
                                        <th class="ps-4 rounded-start">{{ __('Forwarded service') }}</th>
                                        <th class="">{{ __('Name') }}</th>
                                ...
                                <!--begin::Table body-->
                                <tbody>
                                    @forelse ($forwarded_services as $forwarded_service)
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-5">
                                                        <div
                                                            ...
                                                            {{ explode(' ', $forwarded_service->name)[0][0] }}
                                                            {{ explode(' ', $forwarded_service->name)[1][0] ?? '' }}
                                                        </div>
                                                    </div>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <a href="#"
                                                    ...
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title=" {{__(key:'Delete :resource',replace:[ 'resource' => Str::lower(__('Forwarded service'))]) }} ">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5">{{ __(key:'No :resource found.',replace:[ 'resource' => Str::lower(__('Forwarded services'))]) }}</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                                <!--end::Table body-->
