                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                Caso não encontre em anexo os relatórios
                                                                            ...
                                                                            <table role="presentation"
                                                                                ...
                                                                                <tbody>
                                                                                    @php
                                                                                        $index = 0;
                                                                                    @endphp
                                                                                    @foreach ($detalhes['bairros'] as $bairro)
                                                                                    @if ($index == 0)
                                                                                        <tr>
                                                                                    @endif
                                                        ...
                                                        <td
                                                            ...
                                                            <span class="im">
                                                                ...
                                                                <small
                                                                    ...
                                                                    Este email foi enviado automaticamente pelo servidor do <a href="www.sumburero.org">Sumburero</a><br>
                                                                    Em : {{ now()->day . '  de '. __(date_format(now(),'F')). ' de ' . now()->year }}
                                                            </small>
                                                            </span>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';max-width:100vw;padding:32px"
                                                            ...
                                                            <p
                                                                ...
                                                                © {{ date_format(now(), 'Y') }} Sumburero.org. Todos
