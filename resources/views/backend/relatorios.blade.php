                                                                                 ...
                                                                                 @foreach ($detalhes['bairros'] as $bairro)
                                                                                     ...
                                                                                     @switch($index)
                                                                                         @case(0)
                                                                                             ...
                                                                                             <td style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'"
                                                                                                 align="left">
                                                                                                 <a href="{{ URL::temporarySignedRoute('relatorio_mensal', now()->addDays(5), $bairro->uuid) }}"
                                                                                                     rel="noopener"
                                     ...
                                     <td
                                         ...
                                         <span class="im">
                                             ...
                                             <small
                                                 ...
                                                 Este email foi enviado automaticamente pelo servidor do <a
                                                     href="www.sumburero.org">Sumburero</a><br>
                                                 Em :
                                                 {{ now()->day . '  de ' . __(date_format(now(), 'F')) . ' de ' . now()->year }}
                                             </small>
                                         </span>
                                     </td>
                                 </tr>
