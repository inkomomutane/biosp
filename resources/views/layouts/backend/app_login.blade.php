    ...
    <div class="page d-flex flex-row flex-column-fluid">
        <div class="pt-13 d-flex flex-column flex-row-fluid" id="kt_wrapper">
            ...
            <div class="d-flex flex-column flex-root">
                ...
                <div
                    class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed resourse_background_image"
