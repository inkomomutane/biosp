...
<div >
    <a href="{{route('provenace.create')}}" class="btn btn-icon btn-lg btn-success" >add</a>
 </div><br/>
                ...
                <tbody>
                    ...
                    <tr>
                       ...
                       <form action="{{route('provenace.destroy',$provenace->uuid)}}" method="post">
                            ...
                            <a href="{{route('provenace.show',$provenace->uuid)}}" class="btn btn-icon btn-info"><i class="fas fa-info-circle"></i></a>
