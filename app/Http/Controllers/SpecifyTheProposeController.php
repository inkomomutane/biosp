...
use App\Http\Resources\SpecifyTheProposeResource;
use App\Http\Requests\SpecifyTheProposRequest;
use App\Models\SpecifyThePropose;
class SpecifyTheProposeController extends Controller
{
  ...
  try {
       ...
       $getdata_result  =  SpecifyTheProposeResource::collection(SpecifyThePropose::all());
       
       return view('web.backend.admin.specify_the_propose.index')->with('specify_the_proposes',$getdata_result);
